...
DROP INDEX IF EXISTS idx_config_history_key;
CREATE INDEX idx_config_history_key ON configuration_history(setting_key);
DROP INDEX IF EXISTS idx_config_history_by;
CREATE INDEX idx_config_history_by ON configuration_history(changed_by);
DROP INDEX IF EXISTS idx_config_history_created;
CREATE INDEX idx_config_history_created ON configuration_history(created_at DESC);
...
DROP INDEX IF EXISTS idx_member_compliance_category;
CREATE INDEX idx_member_compliance_category ON member_compliance(document_category_code);
DROP INDEX IF EXISTS idx_member_compliance_expiry;
...
DROP INDEX IF EXISTS idx_approval_workflow_member;
CREATE INDEX idx_approval_workflow_member ON member_approval_workflow(member_id);
DROP INDEX IF EXISTS idx_approval_workflow_stage;
CREATE INDEX idx_approval_workflow_stage ON member_approval_workflow(current_stage);
