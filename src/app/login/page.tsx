...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.data?.user?.must_change_password) {
        router.push('/profile?force_password_change=true');
      } else {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">YUNITE</h1>
              <p className="text-indigo-200 text-sm">Enterprise Operating System</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-200 text-sm mt-1">Your data is protected with enterprise-level encryption</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-200 text-sm mt-1">Access your organization from anywhere, anytime</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-200 text-sm mt-1">Monitor your organization with live dashboards</p>
            </div>
          </div>
        </div>

        <div className="text-indigo-200 text-sm">
          &copy; {new Date().getFullYear()} YUNITE Enterprise Portal. All rights reserved.
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="inline-flex items-center gap-3">
              ...
              <div className="text-left">
                <h1 className="text-2xl font-bold text-gray-900">YUNITE</h1>
                <p className="text-gray-500 text-sm">Enterprise Portal</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-500 mt-1">Sign in to access your organization</p>
            </div>
