          ...
          try {
            ...
            await supabase
              ...
              .update({ 
                ...
                notes: `Auto-completed from verified document: ${doc.metadata?.title || doc.fileName}`
              })
            ...
            await supabase
              ...
              .update({ 
                ...
                review_notes: `Auto-completed from verified document: ${doc.metadata?.title || doc.fileName}`
              })
              .eq('member_id', doc.entityId)
          ...
          try {
            ...
            await supabase
              ...
              .update({ 
                status: 'complete', 
                completed_date: new Date().toISOString(),
                notes: `Auto-completed from approved document: ${doc.metadata?.title || doc.fileName}`
              })
              .eq('member_id', doc.entityId)
              .eq('compliance_type', complianceType);
            ...
            await supabase
              ...
              .update({ 
                status: 'approved', 
                reviewed_at: new Date().toISOString(),
                review_notes: `Auto-completed from approved document: ${doc.metadata?.title || doc.fileName}`
              })
              .eq('member_id', doc.entityId)
              .eq('document_category_code', doc.categoryCode);
          } catch (err) {
